...
const INSIGHTS_DATA = [
  ...
  {
    slug:        "optimizing-around-what-ai-cant-do-yet",
    title:       "Optimizing Around What AI Can\u2019t Do Yet",
    date:        "2026-04-01",
    tags:        ["AI & Work", "Strategy", "Leadership"],
    type:        "article",
    excerpt:     "The organizations most at risk from the next wave of AI capability may not be the ones lagging behind. They may be the ones that have adopted carefully and built processes around what AI can reliably do today.",
    coverImage:  "../images/cover/scaffolding.jpg",
    featured:    false,
    body:        null,
  ...
  {
    slug:        "the-ceiling-has-nothing-to-do-with-demand",
    title:       "The Ceiling Has Nothing to Do with Demand",
    date:        "2026-04-01",
    tags:        ["AI & Work", "Strategy"],
    type:        "article",
    excerpt:     "Most high-value advisors aren\u2019t hitting a demand ceiling. They\u2019re hitting a delivery infrastructure ceiling. The conventional solution makes it worse. AI solves it differently.",
    coverImage:  "../images/cover/advisory_ceiling.jpg",
    featured:    false,
    body:        null,
  ...
  {
    slug:        "ai-deployed-into-imagined-workflows",
    title:       "AI Gets Deployed into the Organization You Think You Have",
    date:        "2026-04-01",
    tags:        ["AI & Work", "Leadership", "Strategy"],
    type:        "article",
    excerpt:     "Every organization runs two parallel systems: the process you documented, and the process that actually happens. AI automation reveals the gap between them \u2014 and amplifies whatever is underneath.",
    coverImage:  "../images/cover/imagined_workflows.jpg",
    featured:    false,
    body:        null,
    readingTime: "5 min read",
    show:        null,
